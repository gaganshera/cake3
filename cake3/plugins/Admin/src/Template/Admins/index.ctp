		  ...
		  <td align="left" class="searchbox">
			...
			<?php echo $this->Form->create(null,['type' => 'get']);  ?>
				...
				<div class="floatright top5">
					<?php echo $this->Html->link('<span>Add Admin</span>', array('controller' => 'admins', 'action' => 'add', 'plugin' => 'admin'), array('class' => 'black_btn', 'escape' => false)); ?>
				</div>
		  </td>
	  </tr>
	</table>
...
<div class="row mtop30">
	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" class="listing">
		  <tr>
			...
			<th width="38%" align="left"><?php echo $this->Paginator->sort('first_name'); ?></th>
			<th width="30%" align="left"><?php echo  $this->Paginator->sort('email'); ?></th>
	  ...
	  ?>
			 <tr>
				...
				<td align="left"><span class="blue"><?php echo $user->first_name . ' ' . $user->last_name; ?></span></td>
				<td align="left"><?php echo $user->email; ?></td>
				<td align="left"><?php echo ($user->created) ? $user->created->format('d/m/Y H:i:s') : '' ?></td>
				<td align="center"><?php echo ($user->is_active) ? 'Active' : 'Inactive'; ?></td>
				<td align="center" valign="middle" >&nbsp;<?php echo $this->Html->link($this->Html->image('/admin/images/edit_icon.gif'), array('controller' => 'admins', 'action' => 'edit', $user->id), array('escape' => false)); ?></td>
				<td valign="middle" align="center"><input class = "check-box-select" type="checkbox" value="<?php echo $user->id; ?>" name="ids[]"></td>
			  </tr>
	 <?php
	 	}
	 ?>
